...
INDEX = head("meta.home.title", "meta.home.desc",
             ...
             "Sport media playout, LED video systems and intelligent solutions for professional live environments.").replace(
    '</head>',
...
<meta property="og:title" content="SLAM.SYSTEMS | Intelligent Live Communication Systems">
<meta property="og:description" content="Precision Thinking. Intelligent Systems. Connected Moments.">
<meta property="og:image" content="assets/images/handball-hero-master-v1-scoreboard-correct.png">
</head>'''
) + f'''
<body>
