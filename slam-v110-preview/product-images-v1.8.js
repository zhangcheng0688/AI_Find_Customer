(function () {
  ...
  var images = [
    {
      id: "deckcor",
      src: "assets/images/products/slam_deck_cor_01.jpg",
      alt: "SLAM DECKCOR Bedienoberfläche"
    },
    {
      id: "scorecor",
      src: "assets/images/products/slam_score_cor_handball_01.jpg",
      alt: "SLAM SCORECOR Handball-Bedienoberfläche"
    },
    {
      id: "directorcor",
      src: "assets/images/products/slam_director_cor_01.jpg",
      alt: "SLAM DIRECTORCOR Bedienoberfläche"
    },
    {
      id: "playcor",
      src: "assets/images/products/slam_play_cor_01.jpg",
      alt: "SLAM PLAYCOR Systemdarstellung"
    },
    {
      id: "timecor",
      src: "assets/images/products/slam_time_cor_01.jpg",
  ...
  if (moduleAnchor) {
    moduleAnchor.insertAdjacentElement("afterend", createImage({
      src: "assets/images/products/slam_module_cor_01.jpg",
